<?php $navbar_active = "setting_categories"; ?>
...
<html lang="en">
<head>
	<title>Category Lists - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-sitemap pr-1"></i> Category Lists</h4>
	...
	<script src="../../public/custom/js/settings/categories.js"></script>
	<!-- End Scripts -->
</body>
</html>
...
<html lang="en">
<head>
	<title>Patient Lists - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-users"></i> Patient Lists</h4>
								...
								<div class="card-body">
									...
									<!-- End Show Profile Modal -->

									<!-- Show Medicines Modal -->
                                    <?php include_once('./modal/medicines.php'); ?>
									<!-- End Show Medicines Modal -->
    ...
    <script src="../../public/custom/js/patients.js"></script>

<?php $navbar_active = "reports_receiving"; ?>
...
<html lang="en">
<head>
	<title>Medicine Receiving Report - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-arrow-circle-left pr-1"></i> Medicine Receiving Report</h4>
    ...
    <script src="../../public/custom/js/reports/stocks-receiving.js"></script>
	<!-- End Scripts -->
</body>
</html>
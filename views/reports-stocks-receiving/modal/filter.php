                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="select2-input">
                                    <select id="transaction_id" name="transaction_id" class="form-control select2-list" 
                                        data-module="transactions" data-action="sr-filter" data-type="normal">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="received_at" name="received_at">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="health_official_id">Receiver</label>
                                <div class="select2-input">

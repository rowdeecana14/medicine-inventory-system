<?php $navbar_active = "database_backups"; ?>
...
<html lang="en">
<head>
	<title>Database Backups - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title"><i class="fas fa-database"></i>  Database Backups</h4>
                                        <button class="btn btn-primary btn-round ml-auto btn-backup" >
    ...
    <script src="../../public/custom/js/database-backups.js"></script>
	<!-- End Scripts -->
</body>
</html>
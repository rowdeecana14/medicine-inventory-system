<?php $navbar_active = "reports_medicine"; ?>
...
<html lang="en">
<head>
	<title>Medicine Informations Report - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-medkit"></i> Medicine Information Report</h4>
    ...
    <script src="../../public/custom/js/reports/medicine-informations.js"></script>
	<!-- End Scripts -->
</body>
</html>
<?php $navbar_active = "setting_types"; ?>
...
<html lang="en">
<head>
	<title>Type Lists - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-sitemap pr-1"></i> Type Lists</h4>
	...
	<script src="../../public/custom/js/settings/types.js"></script>
	<!-- End Scripts -->
</body>
</html>
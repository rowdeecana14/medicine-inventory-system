<?php $navbar_active = "medicines_receiving"; ?>
...
<html lang="en">
<head>
	<title>Received Medicine Lists - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-arrow-circle-left pr-1"></i> Received Medicine Lists</h4>
	...
	<script src="../../public/custom/js/medicines/stockin-transactions.js"></script>
	<!-- End Scripts -->
</body>
</html>
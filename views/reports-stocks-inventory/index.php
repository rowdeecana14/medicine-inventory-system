<?php $navbar_active = "reports_inventory"; ?>
...
<html lang="en">
<head>
	<title>Medicine Inventory Report - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-cubes pr-1"></i> Medicine Inventory Report</h4>
    ...
    <script src="../../public/custom/js/reports/stocks-inventory.js"></script>
	<!-- End Scripts -->
</body>
</html>
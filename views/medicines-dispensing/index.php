<?php $navbar_active = "medicines_dispensing"; ?>
...
<html lang="en">
<head>
	<title>Dispensed Medicine Lists - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-arrow-circle-right pr-1"></i>Dispensed Medicine Lists</h4>
	...
	<script src="../../public/custom/js/medicines/stockout-transactions.js"></script>
	<!-- End Scripts -->
</body>
</html>
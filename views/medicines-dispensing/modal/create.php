        ...
        <div class="modal-content">
            <div class="modal-header no-bd">
                <h5 class="modal-title">
                    <i class="fas fa-edit pr-1"></i> DESPENSING FORM
                </h5>
            ...
            <div class="modal-body">
                <form id="create-form">
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="dispenced_at">Date Dispensed<span class="required-label">*</span></label>
                                <input type="text" class="form-control datepicker required current-date input" id="dispenced_at" name="dispenced_at">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="patient_id">Patient <span class="required-label">*</span></label>
                                <div class="select2-input">
                                    <select id="patient_id" name="patient_id" class="form-control select2-list required" 
                                        data-module="patients" data-action="select2" data-type="advanced" data-image-default="patient.png">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="health_official_id">Health Official <span class="required-label">*</span></label>
                                <div class="select2-input">
                                ...
                                <table class="display table table-striped table-hover table-medicine" >
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" class="dosage form-control input" name="dosage[]">
                                                </div>
                                            </td>
                                            <td>

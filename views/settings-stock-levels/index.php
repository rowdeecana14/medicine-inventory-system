<?php $navbar_active = "setting_stock_levels"; ?>
...
<html lang="en">
<head>
	<title>Stock Levels - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-chart-line pr-1"></i> Stock Levels</h4>
									</div>
								</div>
								<div class="card-body">
                                    <!-- Edit Modal -->
    ...
    <script src="../../public/custom/js/settings/stock-levels.js"></script>
	<!-- End Scripts -->
</body>
</html>
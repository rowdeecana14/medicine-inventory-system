<?php $navbar_active = "medicines_inventory"; ?>
...
<html lang="en">
<head>
	<title>Inventory Lists - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-cubes pr-1"></i>Inventory Lists</h4>
									</div>
								</div>
								<div class="card-body">
									<!-- Show Modal -->
	...
	<script src="../../public/custom/js/medicines/inventories.js"></script>
	<!-- End Scripts -->
</body>
</html>
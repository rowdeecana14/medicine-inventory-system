                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="select2-input">
                                    <select id="medicine_id" name="medicine_id" class="form-control select2-list" 
                                        data-module="medicines" 
                                        data-action="report-filter" 
                                        data-type="advanced" 
                                        data-image-default="medicine.jpg"
                                        data-include-all="1"
                                    >
                            ...
                            <div class="form-group">
                                <label for="expired_at">Date Expired</label>
                                <input type="text" class="form-control datepicker" id="expired_at" name="expired_at">
                            </div>

                            <div class="form-group">
                                <label for="status">Statuses <span class="required-label">*</span></label>
                                <select id="status" name="status" class="form-control select-group" >

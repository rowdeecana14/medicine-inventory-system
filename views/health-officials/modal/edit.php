        ...
        <div class="modal-content">
            <div class="modal-header no-bd">
                <h5 class="modal-title">
                    <i class="fas fa-edit pr-1"></i> EDIT HEALTH OFFICIAL INFORMATIONS
                </h5>
                    ...
                    <div class="row">
                                    ...
                                    <div class="profile-picture">
                                        <div class="avatar avatar-xl  image-gallery">
                                            <a href="../../public/assets/img/config/default.png" class="image_href">
                                                <img src="../../public/assets/img/config/default.png" alt="..." class="avatar-img rounded-circle preview-image image_profile"  data-toggle="tooltip" data-placement="bottom" title="View Image">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="form-group success">
                                ...
                                <input type="text" class="form-control datepicker required input" id="edit_birth_date" name="birth_date">
                            </div>

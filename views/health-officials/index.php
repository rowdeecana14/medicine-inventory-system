...
<html lang="en">
<head>
	<title>Health Official Lists - <?= app_code() ?></title>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-user-md"></i> Health Official Lists</h4>
								...
								<div class="card-body">
									...
									<!-- End Show Modal -->
									 ...
									 <!-- Show Meidicnes Modal -->
									 <?php include_once('./modal/medicines.php'); ?>
									<!-- End Show Meidicnes Modal -->

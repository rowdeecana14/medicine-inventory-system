<?php $navbar_active = "setting_diseases"; ?>
...
<html lang="en">
<head>
	<title>Disease Lists - <?= app_code() ?></title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fa fa-bug pr-1"></i> Disease Lists</h4>
	...
	<script src="../../public/custom/js/settings/diseases.js"></script>
	<!-- End Scripts -->
</body>
</html>